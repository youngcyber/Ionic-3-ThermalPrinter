...
export class ESCPOSPrinter {
    ...
    public raster(image: ESCPOSImage, mode: string = 'normal') {
        // Get header
        let header = this.COMMANDS.IMAGE_FORMAT.S_RASTER_N;
     ...
     */
    public printLn() {
        this.write(new Buffer([this.COMMANDS.FEED_CONTROL_SEQUENCES.CTL_CR, this.COMMANDS.FEED_CONTROL_SEQUENCES.CTL_LF]));
    }
    ...
    public align(alignment: string = 'left') {
        ...
        const aligments = {
            ['left']:  this.COMMANDS.TEXT_FORMAT.TXT_ALIGN_LT,
            ['center']:  this.COMMANDS.TEXT_FORMAT.TXT_ALIGN_CT,
            ['right']:  this.COMMANDS.TEXT_FORMAT.TXT_ALIGN_RT
        }
